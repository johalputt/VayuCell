...
<p align="center">
  ...
  <a href="docs/CI.md"><img alt="coverage: 82.67%" src="https://img.shields.io/badge/coverage-82.67%25-success"></a>
  ...
  <a href="scripts/mutation-gate.sh"><img alt="mutations killed: 200/200" src="https://img.shields.io/badge/mutations%20killed-200%2F200-success"></a>
...
| Checked | 362 unit tests and 32 doctests, 82.67% line coverage against an 80% floor, **200 mutations each re-broken and each required to turn its named test red**, and **57 violations planted in a scratch repository that the gates must catch citing the right rule**. None of that is evidence about hardware; all of it is evidence about the code |
...
A full run exercises **362 unit tests and 32 doctests** (2 ignored — the two
snapshot regenerators), kills **200 mutations**, catches **57 planted violations**,
and measures **82.67% line coverage** against a floor of 80. That is a suite that
...
| **Coverage** | Production line coverage below **80%** (measured: 82.67%), with test files excluded so the figure is not inflated by the coverage of the tests themselves. A missing coverage tool is a failure, never a pass |
