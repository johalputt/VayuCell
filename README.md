...
<p align="center">
  ...
  <a href="docs/CI.md"><img alt="coverage: 82.65%" src="https://img.shields.io/badge/coverage-82.65%25-success"></a>
  ...
  <a href="scripts/mutation-gate.sh"><img alt="mutations killed: 190/190" src="https://img.shields.io/badge/mutations%20killed-190%2F190-success"></a>
...
| **Coverage** | Production line coverage below **80%** (measured: 82.65%), with test files excluded so the figure is not inflated by the coverage of the tests themselves. A missing coverage tool is a failure, never a pass |
