...
<p align="center">
  ...
  <a href="scripts/mutation-gate.sh"><img alt="mutations killed: 131/131" src="https://img.shields.io/badge/mutations%20killed-131%2F131-success"></a>
...
| Checked | 264 unit tests and 25 doctests, 80.47% line coverage against an 80% floor, **131 mutations each re-broken and each required to turn its named test red**, and **57 violations planted in a scratch repository that the gates must catch citing the right rule**. None of that is evidence about hardware; all of it is evidence about the code |
...
A full run exercises **264 unit tests and 25 doctests** (2 ignored — the two
snapshot regenerators), kills **131 mutations**, catches **57 planted violations**,
